...
class AdminUserController extends Controller
{
    ...
    private $customer;
    protected $roleuser;
    public function __construct(User $user, Roles $roles, Customer $customer, Role_user $roleuser){
        $this->user = $user;
        $this->roles = $roles;
    ...
    public function index(Request $request){
        ...
        return view('Admin.user.index', compact('user', 'roleuser', 'roles'));
    }
