                ...
                <div class="col-md-12">
                    ...
                    <form method="post" action="{{ route('profile.update', ['id' => $customers->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control @error('name_login') is-invalid @enderror" id="inputEmail3" name="name_login"
                                       value="{{$user->name}}">
                            </div>
                        </div>
                        @error('name_login')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control @error('name_customer') is-invalid @enderror" name="name_customer" placeholder="Name customer"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                            <input type="date" class="form-control @error('birthday') is-invalid @enderror" name="birthday" id="birthday"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                            <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{$customers->address}}"
