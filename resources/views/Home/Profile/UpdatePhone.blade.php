                ...
                <div class="col-md-12">
                    ...
                    @if($confirm == false)
                        <form method="POST" action="{{route('phone_confirm')}}">
                            ...
                            <div class="form-group">
                                <label for="NameLogin" class="col-md-3 col-form-label">Confirm number</label>
                                <div class="col-md-12">
                                    <input type="password" class="form-control @if($error == true) is-invalid @endif"  name="phone_confirm" placeholder="Enter phone">
                                </div>

                                @if($error == true)
                                    <div class="col-md-12 col-error">
                                        <div class="alert alert-danger col-error-2" role="alert">Wrong phone</div>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
